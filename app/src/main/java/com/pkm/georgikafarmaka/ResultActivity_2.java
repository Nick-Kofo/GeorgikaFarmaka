...
public class ResultActivity_2 extends Activity implements OnClickListener {
	@Override
	...
	private void sostaClick() {
		...
		startActivity(new Intent("com.example.triviality.SostaResult_2"));
	}
	private void lathosClick() {

		startActivity(new Intent("com.example.triviality.LathosResult_2"));
	}
