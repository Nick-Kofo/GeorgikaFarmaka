...
public class ResultActivity_5 extends Activity implements OnClickListener {
	@Override
	...
	private void sostaClick() {
		...
		startActivity(new Intent("com.example.triviality.SostaResult_5"));
	}
	private void lathosClick() {

		startActivity(new Intent("com.example.triviality.LathosResult_5"));
	}
