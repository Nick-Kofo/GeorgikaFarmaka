...
public class ResultActivity_6 extends Activity implements OnClickListener {
	@Override
	...
	private void sostaClick() {
		...
		startActivity(new Intent("com.example.triviality.SostaResult_6"));
	}
	private void lathosClick() {

		startActivity(new Intent("com.example.triviality.LathosResult_6"));
	}
