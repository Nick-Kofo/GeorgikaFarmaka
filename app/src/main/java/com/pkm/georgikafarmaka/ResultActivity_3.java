...
public class ResultActivity_3 extends Activity implements OnClickListener {
	@Override
	...
	private void sostaClick() {
		...
		startActivity(new Intent("com.example.triviality.SostaResult_3"));
	}
	private void lathosClick() {

		startActivity(new Intent("com.example.triviality.LathosResult_3"));
	}
