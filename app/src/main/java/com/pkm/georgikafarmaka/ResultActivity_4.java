...
public class ResultActivity_4 extends Activity implements OnClickListener {
	@Override
	...
	private void sostaClick() {
		...
		startActivity(new Intent("com.example.triviality.SostaResult_4"));
	}
	private void lathosClick() {

		startActivity(new Intent("com.example.triviality.LathosResult_4"));
	}
